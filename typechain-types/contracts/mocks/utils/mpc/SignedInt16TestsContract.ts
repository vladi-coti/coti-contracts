...
export type ItInt16Struct = { ciphertext: BigNumberish; signature: BytesLike };

export type ItInt16StructOutput = [ciphertext: bigint, signature: string] & {
  ciphertext: bigint;
  signature: string;
};

export interface SignedInt16TestsContractInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "addResult"
      | "addTest"
...
export interface SignedInt16TestsContract extends BaseContract {
  connect(runner?: ContractRunner | null): SignedInt16TestsContract;
  waitForDeployment(): Promise<this>;

  interface: SignedInt16TestsContractInterface;
  ...
  ): TypedContractMethod<[value: ItInt16Struct], [void], "nonpayable">;
  getFunction(
