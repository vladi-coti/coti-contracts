...
export type ItInt32Struct = { ciphertext: BigNumberish; signature: BytesLike };

export type ItInt32StructOutput = [ciphertext: bigint, signature: string] & {
  ciphertext: bigint;
  signature: string;
};

export interface SignedInt32TestsContractInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "addResult"
      | "addTest"
...
export interface SignedInt32TestsContract extends BaseContract {
  connect(runner?: ContractRunner | null): SignedInt32TestsContract;
  waitForDeployment(): Promise<this>;

  interface: SignedInt32TestsContractInterface;
  ...
  ): TypedContractMethod<[value: ItInt32Struct], [void], "nonpayable">;
  getFunction(
