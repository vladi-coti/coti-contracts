...
export interface SignedInt8TestsContractInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "addResult"
      | "addTest"
...
export interface SignedInt8TestsContract extends BaseContract {
  connect(runner?: ContractRunner | null): SignedInt8TestsContract;
  waitForDeployment(): Promise<this>;

  interface: SignedInt8TestsContractInterface;
