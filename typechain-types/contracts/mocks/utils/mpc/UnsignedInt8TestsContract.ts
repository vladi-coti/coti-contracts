...
export interface UnsignedInt8TestsContractInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "addResult"
      | "addTest"
...
export interface UnsignedInt8TestsContract extends BaseContract {
  connect(runner?: ContractRunner | null): UnsignedInt8TestsContract;
  waitForDeployment(): Promise<this>;

  interface: UnsignedInt8TestsContractInterface;
  ...
  ): TypedContractMethod<[value: ItUint8Struct], [void], "nonpayable">;
  getFunction(
