...
export type ItInt64Struct = { ciphertext: BigNumberish; signature: BytesLike };

export type ItInt64StructOutput = [ciphertext: bigint, signature: string] & {
  ciphertext: bigint;
  signature: string;
};

export interface SignedInt64TestsContractInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "addResult"
      | "addTest"
...
export interface SignedInt64TestsContract extends BaseContract {
  connect(runner?: ContractRunner | null): SignedInt64TestsContract;
  waitForDeployment(): Promise<this>;

  interface: SignedInt64TestsContractInterface;
  ...
  ): TypedContractMethod<[value: ItInt64Struct], [void], "nonpayable">;
  getFunction(
