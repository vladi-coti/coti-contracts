...
export interface PrivacyBridgeERC20MockInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "DEFAULT_ADMIN_ROLE"
...
export interface PrivacyBridgeERC20Mock extends BaseContract {
  connect(runner?: ContractRunner | null): PrivacyBridgeERC20Mock;
  waitForDeployment(): Promise<this>;

  interface: PrivacyBridgeERC20MockInterface;
