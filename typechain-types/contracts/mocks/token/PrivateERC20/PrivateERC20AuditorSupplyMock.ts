...
export interface PrivateERC20AuditorSupplyMockInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "DEFAULT_ADMIN_ROLE"
      | "MINTER_ROLE"
      ...
      | "symbol"
      | "totalSupply"
      | "totalSupplyCiphertextForAuditor"
  ...
  encodeFunctionData(
    functionFragment: "totalSupplyCiphertextForAuditor",
    values?: undefined
  ): string;
  encodeFunctionData(
...
export interface PrivateERC20AuditorSupplyMock extends BaseContract {
  connect(runner?: ContractRunner | null): PrivateERC20AuditorSupplyMock;
  waitForDeployment(): Promise<this>;

  interface: PrivateERC20AuditorSupplyMockInterface;
  ...
  totalSupplyCiphertextForAuditor: TypedContractMethod<
    [],
    [CtUint256StructOutput],
    "nonpayable"
  >;
  ...
  getFunction(
    nameOrSignature: "totalSupplyCiphertextForAuditor"
