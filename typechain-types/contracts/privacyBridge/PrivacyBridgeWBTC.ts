...
export interface PrivacyBridgeWBTCInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "DEFAULT_ADMIN_ROLE"
...
export interface PrivacyBridgeWBTC extends BaseContract {
  connect(runner?: ContractRunner | null): PrivacyBridgeWBTC;
  waitForDeployment(): Promise<this>;

  interface: PrivacyBridgeWBTCInterface;
