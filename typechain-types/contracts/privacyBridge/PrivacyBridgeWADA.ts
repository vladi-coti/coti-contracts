...
export interface PrivacyBridgeWADAInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "DEFAULT_ADMIN_ROLE"
...
export interface PrivacyBridgeWADA extends BaseContract {
  connect(runner?: ContractRunner | null): PrivacyBridgeWADA;
  waitForDeployment(): Promise<this>;

  interface: PrivacyBridgeWADAInterface;
