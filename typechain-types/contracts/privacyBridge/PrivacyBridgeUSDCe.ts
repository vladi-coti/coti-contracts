...
export interface PrivacyBridgeUSDCeInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "DEFAULT_ADMIN_ROLE"
...
export interface PrivacyBridgeUSDCe extends BaseContract {
  connect(runner?: ContractRunner | null): PrivacyBridgeUSDCe;
  waitForDeployment(): Promise<this>;

  interface: PrivacyBridgeUSDCeInterface;
