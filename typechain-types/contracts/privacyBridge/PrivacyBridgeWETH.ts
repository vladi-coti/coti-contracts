...
export interface PrivacyBridgeWETHInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "DEFAULT_ADMIN_ROLE"
...
export interface PrivacyBridgeWETH extends BaseContract {
  connect(runner?: ContractRunner | null): PrivacyBridgeWETH;
  waitForDeployment(): Promise<this>;

  interface: PrivacyBridgeWETHInterface;
