...
export interface PrivacyBridgegCotiInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "DEFAULT_ADMIN_ROLE"
...
export interface PrivacyBridgegCoti extends BaseContract {
  connect(runner?: ContractRunner | null): PrivacyBridgegCoti;
  waitForDeployment(): Promise<this>;

  interface: PrivacyBridgegCotiInterface;
