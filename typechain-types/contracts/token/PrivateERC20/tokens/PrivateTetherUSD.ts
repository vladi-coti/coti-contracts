...
export interface PrivateTetherUSDInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "DEFAULT_ADMIN_ROLE"
      | "MINTER_ROLE"
...
export interface PrivateTetherUSD extends BaseContract {
  connect(runner?: ContractRunner | null): PrivateTetherUSD;
  waitForDeployment(): Promise<this>;

  interface: PrivateTetherUSDInterface;
