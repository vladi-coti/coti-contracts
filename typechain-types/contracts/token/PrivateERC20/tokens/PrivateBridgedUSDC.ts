...
export interface PrivateBridgedUSDCInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "DEFAULT_ADMIN_ROLE"
      | "MINTER_ROLE"
...
export interface PrivateBridgedUSDC extends BaseContract {
  connect(runner?: ContractRunner | null): PrivateBridgedUSDC;
  waitForDeployment(): Promise<this>;

  interface: PrivateBridgedUSDCInterface;
