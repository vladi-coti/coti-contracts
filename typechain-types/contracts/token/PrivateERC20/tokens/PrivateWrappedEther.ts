...
export interface PrivateWrappedEtherInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "DEFAULT_ADMIN_ROLE"
      | "MINTER_ROLE"
...
export interface PrivateWrappedEther extends BaseContract {
  connect(runner?: ContractRunner | null): PrivateWrappedEther;
  waitForDeployment(): Promise<this>;

  interface: PrivateWrappedEtherInterface;
