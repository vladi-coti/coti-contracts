...
export interface PrivateCOTIInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "DEFAULT_ADMIN_ROLE"
      | "MINTER_ROLE"
...
export interface PrivateCOTI extends BaseContract {
  connect(runner?: ContractRunner | null): PrivateCOTI;
  waitForDeployment(): Promise<this>;

  interface: PrivateCOTIInterface;
