...
export interface PrivateWrappedADAInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "DEFAULT_ADMIN_ROLE"
      | "MINTER_ROLE"
...
export interface PrivateWrappedADA extends BaseContract {
  connect(runner?: ContractRunner | null): PrivateWrappedADA;
  waitForDeployment(): Promise<this>;

  interface: PrivateWrappedADAInterface;
