...
export interface PrivateCOTITreasuryGovernanceTokenInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "DEFAULT_ADMIN_ROLE"
      | "MINTER_ROLE"
...
export interface PrivateCOTITreasuryGovernanceToken extends BaseContract {
  connect(runner?: ContractRunner | null): PrivateCOTITreasuryGovernanceToken;
  waitForDeployment(): Promise<this>;

  interface: PrivateCOTITreasuryGovernanceTokenInterface;
