...
export interface PrivateWrappedBTCInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "DEFAULT_ADMIN_ROLE"
      | "MINTER_ROLE"
...
export interface PrivateWrappedBTC extends BaseContract {
  connect(runner?: ContractRunner | null): PrivateWrappedBTC;
  waitForDeployment(): Promise<this>;

  interface: PrivateWrappedBTCInterface;
