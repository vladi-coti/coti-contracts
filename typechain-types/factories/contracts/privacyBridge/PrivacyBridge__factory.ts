...
import type {
  PrivacyBridge,
  PrivacyBridgeInterface,
} from "../../../contracts/privacyBridge/PrivacyBridge";
...
export class PrivacyBridge__factory {
  static readonly abi = _abi;
  static createInterface(): PrivacyBridgeInterface {
    return new Interface(_abi) as PrivacyBridgeInterface;
  }
  static connect(
    address: string,
    runner?: ContractRunner | null
  ): PrivacyBridge {
    return new Contract(address, _abi, runner) as unknown as PrivacyBridge;
  }
}
